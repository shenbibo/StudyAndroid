...
public class MainActivity2 extends BaseActivity {
    ...
    protected void initViews() {
        ...
        //        RecyclerViewAdapter adapter = new RecyclerViewAdapter(this, provider);
        //        recyclerView.setAdapter(adapter);

        /////////test_end/////////
        Log.d(TAG, "onCreate called");
        //init Fragment
        //注意Fragment是可以从异常中自动恢复的（横竖屏切换）
        ...
        //init presenter
        //即使Fragment的状态有保存，也没有保存presenter，所以需要重新设置。
        presenter = new MainPresenterImpl(fragment);
